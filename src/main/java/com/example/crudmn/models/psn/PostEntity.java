...
public class PostEntity {
    ...
    public PostEntity(String id, String userId, String originalUserId, String content, String image, Instant createdAt, List<String> love, List<String> share, List<CommentEntity> comment) {
        this.id = id;
        this.userId = userId;
        this.originalUserId = originalUserId;
        this.content = content;
