...
public class SongService {
    ...
    public Page<SongNotUri> listByPage(Integer pageNum, String keyword, Integer num) {
        int songPerPage = 0;
        if(num != null) {
            songPerPage = num;
        }
    ...
    public List<SongNotUri> getSongSuggested(List<Integer> listIdArtist, List<Integer> listIdCategory, List<Integer> listIds) {
